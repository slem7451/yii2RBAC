...
class SiteController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'only' => ['logout', 'signup', 'create', 'update', 'block', 'unblock'],
                'rules' => [
                    [
    ...
    {
        $users = new User();
        if (Yii::$app->user->can('clientCRUD') || Yii::$app->user->can('outsourceCRUD'))
